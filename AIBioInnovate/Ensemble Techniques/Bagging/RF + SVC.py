...
svc_bagging_clf = BaggingClassifier(base_estimator=svc_clf, n_estimators=10, random_state=42)
...
svc_predictions = svc_bagging_clf.predict(X_test)
...
print(f"SVC Bagging Classifier Accuracy: {svc_accuracy}")
print(f"SVC Bagging Classifier Recall: {svc_recall}")
print(f"SVC Bagging Classifier F1 Score: {svc_f1}")

# Print classification reports
print("Random Forest Bagging Classifier Report:")
print(classification_report(y_test, rf_predictions))

print("SVC Bagging Classifier Report:")
