...
knn_boosted = AdaBoostClassifier(base_estimator=knn, n_estimators=50, random_state=42)
...
print(f"KNN Boosted Accuracy: {accuracy_score(y_test, knn_predictions)}")
